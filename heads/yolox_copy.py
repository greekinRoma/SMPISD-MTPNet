...
import math
from ..layers.lmpcm.lca_6 import ExpansionContrastModule
class YOLOHead(nn.Module):
    def __init__(
        ...
        for i in range(len(in_channels)):
            self.lca_layers.append(
                ExpansionContrastModule(in_channels=int(256*width),shifts=[1,3])
            )
