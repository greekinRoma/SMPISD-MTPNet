...
class YOLOHead(nn.Module):
    def __init__(
        ...
        for i in range(len(in_channels)):
            ...
            self.reg_preds.append(ExpansionContrastModule(in_channels=int(width*256),out=4))
            ...
            self.mask_preds.append(ExpansionContrastModule(in_channels=int(width*256),out=1))
